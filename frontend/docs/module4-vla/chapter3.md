---
title: ROS 2 Action Sequencing - Executing Planned Actions
id: module4-vla-chapter3
sidebar_label: Chapter 3 - ROS 2 Action Sequencing
sidebar_position: 18
description: Understanding ROS 2 action sequencing for executing planned robot actions
---
...
class ActionSequencerNode(Node):
    ...
    def get_result_callback(self, future):
        ...
        if result.success:
            ...
            time.sleep(0.5)
            self.execute_next_action_in_plan() # Proceed to the next action in the plan
        else:
