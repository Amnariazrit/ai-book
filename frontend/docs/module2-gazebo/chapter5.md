...
id: module2-gazebo-chapter5
sidebar_label: Chapter 5 - Sensor Simulation
sidebar_position: 10
description: Understanding sensor simulation in Gazebo for LiDAR, depth camera, and IMU sensors
---
